...
export function JobsList() {
  ...
  const { data: jobs, isLoading } = useBackfillJobs(
    statusFilter !== "all"
      ? { status: statusFilter as BackfillJobStatus }
      : undefined,
  );
  ...
  const handlePause = async (jobId: string) => {
    try {
      ...
      toast({
        title: "Lỗi",
        description:
          error instanceof Error ? error.message : "Không thể tạm dừng",
        variant: "destructive",
      });
    }
  };
  ...
  const handleResume = async (jobId: string) => {
    try {
      ...
      toast({
        title: "Lỗi",
        description:
          error instanceof Error ? error.message : "Không thể tiếp tục",
        variant: "destructive",
      });
    }
  };
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="text-lg">
                      {job.jobType === "full_historical"
                        ? "Thu thập toàn bộ lịch sử"
                        : "Thu thập theo khoảng thời gian"}
                    </CardTitle>
