...
export async function PUT(
  ...
  try {
    ...
    if (validated.featuredImageUrl !== undefined)
      updateData.featured_image_url = validated.featuredImageUrl;
    if (validated.categoryId !== undefined)
      updateData.category_id = validated.categoryId;
    if (validated.metaTitle !== undefined)
      updateData.meta_title = validated.metaTitle;
    if (validated.metaDescription !== undefined)
      updateData.meta_description = validated.metaDescription;
    if (validated.ogImageUrl !== undefined)
      updateData.og_image_url = validated.ogImageUrl;
