...
export async function PUT(
  ...
  try {
    ...
    if (validated.apiType !== undefined) updateData.api_type = validated.apiType
    ...
    if (validated.authType !== undefined) updateData.auth_type = validated.authType
    if (validated.authConfig !== undefined) updateData.auth_config = validated.authConfig
    if (validated.rateLimitPerMinute !== undefined) updateData.rate_limit_per_minute = validated.rateLimitPerMinute
    if (validated.timeoutSeconds !== undefined) updateData.timeout_seconds = validated.timeoutSeconds
